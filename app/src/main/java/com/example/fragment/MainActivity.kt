...
class MainActivity : AppCompatActivity(), DialogInterface.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        change_design.setOnClickListener{
            ...
            MyDialog().show(supportFragmentManager, "test")
    ...
    override fun onClick(dialog: DialogInterface?, which: Int) {
        val textView:Button=findViewById(R.id.design_btn)
        when (which){
            DialogInterface.BUTTON_POSITIVE -> change_design();
            DialogInterface.BUTTON_NEGATIVE -> textView.setText("Сменить дизайн");
        }
    }
